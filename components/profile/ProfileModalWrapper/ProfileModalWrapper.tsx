...
const ProfileModalWrapper = (
  ...
  return (
    <>
      {confirmModalIsOpen ? (
        <div className='absolute z-50 top-22 px-2 w-full bg-brand-lightbackground min-h-screen pt-18 text-white'>
        ...
        <div
          className='absolute pt-40 min-h-screen w-full rounded text-white pointer-events-none flex items-stretch lg:block lg:static lg:p-0 lg:min-h-0 lg:rounded-0 lg:pointer-events-auto'
          ref={modalRef}
        >
          <div className='bg-brand-lightbackground w-full lg:bg-transparent z-30'>
