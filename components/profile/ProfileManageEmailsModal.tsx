...
const ProfileManageEmailsModal = (props: {
  ...
  return (
    <div className='lg:hidden absolute pt-40 min-h-screen w-full rounded text-white pointer-events-none flex items-stretch z-20'>
      <div className='bg-brand-lightbackground w-full'>
        <div className='bg-brand-lightmodal p-8 pointer-events-auto'>
