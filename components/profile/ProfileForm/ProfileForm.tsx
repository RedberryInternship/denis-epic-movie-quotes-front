...
const ProfileForm = (props: PropsType) => {
  ...
  return (
    ...
    >
      ...
      <section className='max-h-[calc(100vh-10.5rem)] overflow-y-scroll bg-brand-lightmodal pt-10 pb-22.5 px-8 rounded-xl mt-4 lg:bg-brand-article lg:mt-[5vh] 2xl:mt-[11.6vh] lg:pt-0 lg:pl-21 lg:pr-8'>
