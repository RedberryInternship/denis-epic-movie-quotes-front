const Heart = (props: { isActive: boolean }) => {
  return (
    <svg
      width='24'
      height='24'
      ...
      className='text-white hover:text-[#F3426C]'
    >
