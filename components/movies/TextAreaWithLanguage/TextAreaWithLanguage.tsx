  ...
  return (
    <div className='relative'>
      <textarea
        ...
        className={
          'h-21.5 pr-12 overflow-hidden border border-brand-subtitle bg-transparent rounded px-[17px] w-full mb-4 lg:mb-5 placeholder:text-[#CCC] focus:outline-[#A9B4BE] focus:outline-[#A9B4BE] focus:ring-[#A9B4BE] focus:ring-offset-0 focus:outline-offset-0 focus:outline-4 focus:border-brand-subtitle ' +
          (hasErrors
