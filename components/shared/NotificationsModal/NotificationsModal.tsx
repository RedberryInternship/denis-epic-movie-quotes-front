...
const NotificationsModal = (props: {
  ...
  return (
    <div className='absolute z-50 bg-black top-22 text-white w-full px-9 pb-40 pt-5.5 rounded-xl lg:w-[600px] 2xl:w-[961px] lg:pr-0 lg:right-16 lg:pb-9 lg:pt-10 animate-grow-y origin-top lg:h-auto'>
